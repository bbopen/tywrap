"""
BridgeCodec Test Suite for Python

Comprehensive tests for the BridgeCodec class that provides safe JSON
encoding/decoding with explicit edge case handling for the JS<->Python bridge.

Run with: pytest test/python/test_bridge_codec.py -v
"""
...
@pytest.fixture
def codec() -> BridgeCodec:
    """Default codec with standard settings."""
    return BridgeCodec()


@pytest.fixture
def permissive_codec() -> BridgeCodec:
    """Codec that allows NaN/Infinity."""
    return BridgeCodec(allow_nan=True)


@pytest.fixture
def small_codec() -> BridgeCodec:
    """Codec with small payload limit for testing size limits."""
    return BridgeCodec(max_payload_bytes=100)
...
class TestBasicEncodingDecoding:
    ...
    def test_round_trip_simple_values(self, codec: BridgeCodec) -> None:
    ...
    def test_round_trip_lists(self, codec: BridgeCodec) -> None:
    ...
    def test_round_trip_dicts(self, codec: BridgeCodec) -> None:
    ...
    def test_round_trip_nested_structures(self, codec: BridgeCodec) -> None:
    ...
    def test_encode_produces_valid_json(self, codec: BridgeCodec) -> None:
...
class TestNanInfinityRejection:
    ...
    def test_reject_nan_when_allow_nan_false(self, codec: BridgeCodec) -> None:
        """NaN should raise CodecError when allow_nan is False."""
        with pytest.raises(CodecError) as exc_info:
            codec.encode(float('nan'))
        assert 'NaN' in str(exc_info.value)

    def test_reject_infinity_when_allow_nan_false(self, codec: BridgeCodec) -> None:
    ...
    def test_reject_negative_infinity_when_allow_nan_false(self, codec: BridgeCodec) -> None:
        """Negative infinity should raise CodecError when allow_nan is False."""
        with pytest.raises(CodecError) as exc_info:
            codec.encode(float('-inf'))
        assert 'NaN' in str(exc_info.value) or 'Infinity' in str(exc_info.value)

    def test_reject_nan_in_nested_structure(self, codec: BridgeCodec) -> None:
        """NaN in nested structure should raise CodecError."""
        value = {'a': {'b': {'c': float('nan')}}}
        with pytest.raises(CodecError):
            codec.encode(value)

    def test_reject_nan_in_list(self, codec: BridgeCodec) -> None:
        """NaN in list should raise CodecError."""
        value = [1, 2, float('nan'), 4]
        with pytest.raises(CodecError):
            codec.encode(value)

    def test_allow_nan_when_enabled(self, permissive_codec: BridgeCodec) -> None:
    ...
    def test_allow_infinity_when_enabled(self, permissive_codec: BridgeCodec) -> None:
        """Infinity should serialize when allow_nan is True."""
        value = {'pos': float('inf'), 'neg': float('-inf')}
        encoded = permissive_codec.encode(value)
        assert 'Infinity' in encoded

    def test_valid_floats_pass(self, codec: BridgeCodec) -> None:
...
class TestNumpyScalarHandling:
    ...
    def test_numpy_float64_serializes(self, codec: BridgeCodec) -> None:
    ...
    def test_numpy_int32_serializes(self, codec: BridgeCodec) -> None:
    ...
    def test_numpy_int64_serializes(self, codec: BridgeCodec) -> None:
    ...
    def test_numpy_bool_serializes(self, codec: BridgeCodec) -> None:
    ...
    def test_numpy_nan_raises_when_allow_nan_false(self, codec: BridgeCodec) -> None:
    ...
    def test_numpy_inf_raises_when_allow_nan_false(self, codec: BridgeCodec) -> None:
    ...
    def test_numpy_nan_allowed_when_enabled(self, permissive_codec: BridgeCodec) -> None:
    ...
    def test_numpy_0d_array_serializes(self, codec: BridgeCodec) -> None:
...
class TestPandasHandling:
    ...
    def test_pandas_nat_serializes_to_null(self, codec: BridgeCodec) -> None:
    ...
    def test_pandas_timestamp_serializes_to_iso_string(self, codec: BridgeCodec) -> None:
    ...
    def test_pandas_timestamp_with_timezone(self, codec: BridgeCodec) -> None:
    ...
    def test_pandas_timedelta_serializes_to_seconds(self, codec: BridgeCodec) -> None:
...
class TestDatetimeHandling:
    ...
    def test_datetime_serializes_to_iso_string(self, codec: BridgeCodec) -> None:
    ...
    def test_datetime_with_microseconds(self, codec: BridgeCodec) -> None:
    ...
    def test_date_serializes_to_iso_string(self, codec: BridgeCodec) -> None:
    ...
    def test_time_serializes_to_iso_string(self, codec: BridgeCodec) -> None:
    ...
    def test_timedelta_serializes_to_seconds(self, codec: BridgeCodec) -> None:
    ...
    def test_timedelta_with_days(self, codec: BridgeCodec) -> None:
    ...
    def test_negative_timedelta(self, codec: BridgeCodec) -> None:
...
class TestSpecialTypes:
    ...
    def test_decimal_serializes_to_string(self, codec: BridgeCodec) -> None:
    ...
    def test_decimal_with_exponent(self, codec: BridgeCodec) -> None:
    ...
    def test_uuid_serializes_to_string(self, codec: BridgeCodec) -> None:
    ...
    def test_path_serializes_to_string(self, codec: BridgeCodec) -> None:
    ...
    def test_pure_path_serializes_to_string(self, codec: BridgeCodec) -> None:
    ...
    def test_bytes_serialize_to_base64_marker(self, codec: BridgeCodec) -> None:
    ...
    def test_bytearray_serializes_to_base64_marker(self, codec: BridgeCodec) -> None:
    ...
    def test_empty_bytes(self, codec: BridgeCodec) -> None:
    ...
    def test_set_serializes_to_list(self, codec: BridgeCodec) -> None:
    ...
    def test_frozenset_serializes_to_list(self, codec: BridgeCodec) -> None:
...
class TestPydanticHandling:
    ...
    def test_pydantic_model_uses_model_dump(self, codec: BridgeCodec) -> None:
    ...
    def test_pydantic_model_with_alias(self, codec: BridgeCodec) -> None:
    ...
    def test_pydantic_nested_model(self, codec: BridgeCodec) -> None:
...
class TestSizeLimits:
    ...
    def test_large_payload_raises_codec_error(self, small_codec: BridgeCodec) -> None:
    ...
    def test_small_payload_passes(self, small_codec: BridgeCodec) -> None:
        """Payload under limit should not raise."""
        small_data = {'a': 1}
        # Should not raise
        small_codec.encode(small_data)

    def test_decode_respects_size_limit(self, small_codec: BridgeCodec) -> None:
    ...
    def test_default_limit_is_10mb(self, codec: BridgeCodec) -> None:
    ...
    def test_custom_limit_is_respected(self) -> None:
        ...
        custom_codec = BridgeCodec(max_payload_bytes=500)
    ...
    def test_size_calculated_in_bytes_not_characters(self) -> None:
        ...
        codec = BridgeCodec(max_payload_bytes=50)
...
class TestErrorMessages:
    ...
    def test_nan_error_message_is_clear(self, codec: BridgeCodec) -> None:
    ...
    def test_size_error_includes_limit(self, small_codec: BridgeCodec) -> None:
    ...
    def test_invalid_json_decode_error(self, codec: BridgeCodec) -> None:
    ...
    def test_non_serializable_type_error(self, codec: BridgeCodec) -> None:
...
class TestEdgeCases:
    ...
    def test_empty_dict(self, codec: BridgeCodec) -> None:
        """Empty dict should serialize correctly."""
        encoded = codec.encode({})
        decoded = codec.decode(encoded)
        assert decoded == {}

    def test_empty_list(self, codec: BridgeCodec) -> None:
        """Empty list should serialize correctly."""
        encoded = codec.encode([])
        decoded = codec.decode(encoded)
        assert decoded == []

    def test_empty_string(self, codec: BridgeCodec) -> None:
        """Empty string should serialize correctly."""
        encoded = codec.encode('')
        decoded = codec.decode(encoded)
        assert decoded == ''

    def test_deeply_nested_structure(self, codec: BridgeCodec) -> None:
    ...
    def test_unicode_strings(self, codec: BridgeCodec) -> None:
    ...
    def test_escape_sequences_in_strings(self, codec: BridgeCodec) -> None:
    ...
    def test_very_large_numbers(self, codec: BridgeCodec) -> None:
    ...
    def test_very_small_numbers(self, codec: BridgeCodec) -> None:
    ...
    def test_zero_values(self, codec: BridgeCodec) -> None:
    ...
    def test_complex_number_raises_error(self, codec: BridgeCodec) -> None:
        """Complex numbers should raise error (not JSON serializable)."""
        with pytest.raises(CodecError):
            codec.encode({'value': 1 + 2j})

    def test_none_values_in_structures(self, codec: BridgeCodec) -> None:
    ...
    def test_boolean_values(self, codec: BridgeCodec) -> None:
    ...
    def test_mixed_type_list(self, codec: BridgeCodec) -> None:
