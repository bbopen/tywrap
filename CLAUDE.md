...
> This file helps Claude Code understand the tywrap codebase and contribute effectively.
> See also AGENTS.md (generic version for other AI coding assistants).
