...
// Quick start should work the same way
const quickStartResult = await quickStart();
const quickStartWithConfig = await quickStart({});

// =============================================================================
// PyAnalyzer Type Tests
// =============================================================================

// PyAnalyzer should be constructible and have correct methods
const analyzer = new PyAnalyzer();
expectType<PyAnalyzer>(analyzer);
expectType<Promise<void>>(analyzer.initialize());
expectType<Promise<AnalysisResult>>(analyzer.analyzePythonModule('code'));
expectType<Promise<AnalysisResult>>(analyzer.analyzePythonModule('code', '/path/to/file.py'));
